...
export class FBOLightingRenderer2 implements IRenderer {
    ...
    private renderSurface() {
        ...
        this.gl.vertexAttribPointer(this.lightingShader.attribute.aColor, 1, WebGLRenderingContext.FLOAT, false, 20, 16);
        ...
        this.gl.vertexAttribPointer(this.lightingShader.attribute.aVertexPosition, 2, WebGLRenderingContext.FLOAT, false, 20, 0);
        this.gl.vertexAttribPointer(this.lightingShader.attribute.aTextureCoord, 2, WebGLRenderingContext.FLOAT, false, 20, 8);
        this.gl.vertexAttribPointer(this.lightingShader.attribute.aColor, 1, WebGLRenderingContext.FLOAT, false, 20, 16);
        // this.gl.activeTexture(WebGLRenderingContext.TEXTURE0);
        // this.gl.bindTexture(WebGLRenderingContext.TEXTURE_2D, texture);
        this.gl.drawElements(WebGLRenderingContext.TRIANGLES, this.indexRun * 6, WebGLRenderingContext.UNSIGNED_SHORT, 0);
    }
